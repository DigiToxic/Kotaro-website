  ...
  return (
    <Container id="Feature">
      ...
      <Text>
        <h1>KotaroMap</h1>
        <p>
          Our efforts have always been centered on four key components:
          producing amazing art, developing a strong community, assembling a
          qualified and experienced team, and using these building blocks to
          enable future growth. By prioritizing these areas, we aim to take
          Kotaro to the next level and create a sustainable model for long-term
          success. We really forgot the fourth huh?
        </p>
      </Text>

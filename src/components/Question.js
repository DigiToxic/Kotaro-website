      ...
      <div rotation={rotation} onClick={handleClick}>
        <Box onClick={() => setIsVisible(!isVisible)}>
          ...
          <BurgerNav isVisible={isVisible}>
            <p>
              Ledding by a team of blockchain enthusiasts and collectors that
              have experience in fields like business management, design, and
      ...
      <div rotation={rotation2} onClick={handleClick2}>
        <Box onClick={() => setIsVisible2(!isVisible2)} rotation={rotation2}>
          ...
          <BurgerNav3 isVisible={isVisible2}>
            <p>
              Utility is a mysterious force that drives our actions, yet it
              remains hidden from view. We can only trust our instincts and make
              our best guesses. Even the most carefully planned actions can be
              upended by the unpredictable nature of utility. Only time will
              tell!
            </p>
          </BurgerNav3>
        </Box>
      ...
      <div rotation={rotation3} onClick={handleClick3}>
        <Box onClick={() => setIsVisible3(!isVisible3)}>
          ...
          <BurgerNav4 isVisible={isVisible3}>
            <p>
              Join our community by registering for our{" "}
              <a
                href="https://www.premint.xyz/home/"
                rel="noreferrer"
                target="_blank"
              >
                premint
              </a>{" "}
              or engaging with our tweets, and become a part of our mission to
              shape the future of NFT.
            </p>
          </BurgerNav4>
        </Box>
      </div>
      ...
      <div rotation={rotation5} onClick={handleClick5}>
        <Box onClick={() => setIsVisible5(!isVisible5)}>
          ...
          <BurgerNav6 isVisible={isVisible5}>
            <p>
              We will be sharing all the exciting details with you in the near
              future. Stay tune for updates on our latest updates by following
              us on{" "}
              <a
                href="https://twitter.com/ProjectKotaro"
                rel="noreferrer"
                target="_blank"
              >
                Twitter.
        ...
        <Box2 onClick={() => setIsVisible6(!isVisible6)}>
          ...
          <BurgerNav2 isVisible={isVisible6}>
            <p>
              ...
              or DM us on twitter and we will get in touch with you!
            </p>
          </BurgerNav2>
        </Box2>
      </div>

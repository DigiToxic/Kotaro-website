    ...
    <Container>
      ...
      <Section2>
        <Text>
          ...
          <Link activeClass="active" to="Feature" spy={true} smooth={true}>
            <p className="text">KotaroMap</p>
          </Link>
          <Link activeClass="active" to="Question" spy={true} smooth={true}>
        ...
        <Image>
          <a
            ...
            target="_blank"
          >
            <img className="photo1" src="/images/twitter.png" alt="" />
          </a>
